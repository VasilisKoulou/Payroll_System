...
public class Pinakas6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Κωδικός εργαζομένου", "Ημ. Πρόσληψης", "Ημ. Παύσης εργασίας"
            }
        ) {
 ...
 public void showtable(){
    ...
    try {
        ...
        String Κωδικός_εργαζομένου = jTextField2.getText();
        String Ημερομηνία_προσλήψεων = jTextField3.getText();
        String Ημερομηνία_παύσης = jTextField4.getText();

        
        String updateQuery = "UPDATE ημερομηνίες_προσλήψεων_απολύσεων " +
                "SET Κωδικός_εργαζομένου = '" + Κωδικός_εργαζομένου + "', " +
                "Ημερομηνία_προσλήψεων = '" + Ημερομηνία_προσλήψεων + "', " +
                "Ημερομηνία_παύσης = '" + Ημερομηνία_παύσης + "' " +
                "WHERE id_ημερομηνίες = " + model.getValueAt(selectedRow, 0);
...
try {
    ...
    String id_ημερομηνίες = model.getValueAt(selectedRow, 0).toString();

    
    String deleteQuery = "DELETE FROM ημερομηνίες_προσλήψεων_απολύσεων WHERE id_ημερομηνίες = " + id_ημερομηνίες;
