...
public class Pinakas9 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Κωδικός εργαζομένου", "Παρουσίες", "Απουσίες"
            }
        ) {
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(jTextField2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE))))
                                .addGap(182, 182, 182)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
public void showtable(){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
           con = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
           Statement stmt = (Statement) con.createStatement();
           String st = "insert into αποδοχές(Κωδικός_εργαζομένου,Παρουσίες,Απουσίες) values ('"
                        + jTextField1.getText() + "','"
                        + jTextField2.getText() + "','"
                        + jTextField3.getText() +  "')";
...
try {
    ...
    String selectRandomQuery = "SELECT Κωδικός_εργαζομένου FROM αποδοχές ORDER BY RAND() LIMIT 1";
    ...
    if (resultSet.next()) {
        ...
        String st = "UPDATE αποδοχές " +
            "SET Κωδικός_εργαζομένου = '" + jTextField1.getText() + "', " +
            "Παρουσίες = '" + jTextField2.getText() + "', " +
            "Απουσίες = '" + jTextField3.getText() + "' " +
...
try {
    ...
    if (resultSet.next()) {
        ...
        String deleteQuery = "DELETE FROM αποδοχές WHERE Κωδικός_εργαζομένου = " + Κωδικός_εργαζομένου;
