...
public class Pinakas4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Κωδικός εργαζομένου", "Τηλέφωνο 1", "Τηλέφωνο 2", "Τηλέφωνο 3"
            }
        ) {
    ...
    try {
        ...
        String Τηλέφωνο1 = jTextField2.getText();
        String Τηλέφωνο2 = jTextField3.getText();
        String Τηλέφωνο3 = jTextField4.getText();

        
        String updateQuery = "UPDATE τηλέφωνα_εργαζομένων " +
                "SET Κωδικός_εργαζομένου = '" + Κωδικός_εργαζομένου + "', " +
                "Τηλέφωνο1 = '" + Τηλέφωνο1 + "', " +
                "Τηλέφωνο2 = '" + Τηλέφωνο2 + "', " +
                "Τηλέφωνο3 = '" + Τηλέφωνο3 + "' " +
                "WHERE id_τηλέφωνα = " + model.getValueAt(selectedRow, 0);
...
try {
    ...
    String id_τηλέφωνα = model.getValueAt(selectedRow, 0).toString();

    
    String deleteQuery = "DELETE FROM τηλέφωνα_εργαζομένων WHERE id_τηλέφωνα = " + id_τηλέφωνα;
