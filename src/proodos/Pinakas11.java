...
try {
    ...
    String selectRandomQuery = "SELECT Κωδικός_εργαζομένων FROM εξουσιοδοτημένοι_χρήστες ORDER BY RAND() LIMIT 1";
    ...
    if (resultSet.next()) {
        ...
        String st = "UPDATE εξουσιοδοτημένοι_χρήστες " +
...
try {
    ...
    if (resultSet.next()) {
        ...
        String deleteQuery = "DELETE FROM εξουσιοδοτημένοι_χρήστες WHERE Κωδικός_εργαζομένων = " + Κωδικός_εργαζομένων;
