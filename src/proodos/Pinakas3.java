...
public class Pinakas3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id Τύπος", "Κωδικός εργαζομένου", "Ωρομίσθιος", "Αορίστου Χρόνου", "Συμβασιούχος"
            }
        ));
...
try {
    ...
    String selectRandomQuery = "SELECT Κωδικός_εργαζομένου FROM τύπος_εργαζομένου ORDER BY RAND() LIMIT 1";
    ...
    if (resultSet.next()) {
        ...
        String deleteQuery = "DELETE FROM τύπος_εργαζομένου WHERE Κωδικός_εργαζομένου = " + Κωδικός_εργαζομένου;
...
try {
    ...
    if (resultSet.next()) {
        String Κωδικός_εργαζομένου = resultSet.getString("Κωδικός_εργαζομένου");
        String st = "UPDATE τύπος_εργαζομένου " +
                "SET Κωδικός_εργαζομένου= '" + jTextField1.getText() + "', " +
                "Ωρομίσθιος = '" + jTextField2.getText() + "', " +
                "Αορίστου_χρόνου = '" + jTextField3.getText() + "', " +
                "Συμβασιούχος = '" + jTextField4.getText() + "' " +
