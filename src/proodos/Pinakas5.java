...
public class Pinakas5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Κωδικός εργαζομένου", "email 1", "email 2"
            }
        ) {
    ...
    try {
        ...
        String email2 = jTextField3.getText();

        
        String updateQuery = "UPDATE email_εργαζομένων " +
                "SET Κωδικός_εργαζομένου = '" + Κωδικός_εργαζομένου + "', " +
                "email1 = '" + email1 + "', " +
                "email2 = '" + email2 + "' " +
                "WHERE idemail_εργαζομένων = " + model.getValueAt(selectedRow, 0);
...
try {
    ...
    String idemail_εργαζομένων = model.getValueAt(selectedRow, 0).toString();

    
    String deleteQuery = "DELETE FROM email_εργαζομένων WHERE idemail_εργαζομένων = " + idemail_εργαζομένων;
