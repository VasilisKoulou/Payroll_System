...
public class Pinakas7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Μισθοί εργαζομένων");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id Μισθοί", "Κωδικός εργαζομένου", "Μηνιαίος μισθός", "Ωριαίος μισθός"
            }
        ) {
        ...
        jLabel4.setText("Μηνιαίος μισθός");
...
public void showtable(){
        ...
        model.setRowCount(0);
         try{
           ...
           String st = "select * from μισθοι_εργαζομενων";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
           con = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
           Statement stmt = (Statement) con.createStatement();
           String st = "insert into μισθοι_εργαζομενων(Κωδικός_εργαζομένου,Μηνιαίος_μισθός,Ωριαίος_μισθός) values ('"
                        + jTextField1.getText() + "','"
                        + jTextField2.getText() + "','"
                        + jTextField3.getText() + "')";
...
try {
    ...
    String selectRandomQuery = "SELECT Κωδικός_εργαζομένου FROM μισθοι_εργαζομενων ORDER BY RAND() LIMIT 1";
    ...
    if (resultSet.next()) {
        ...
        String st = "UPDATE μισθοι_εργαζομενων " +
            "SET Κωδικός_εργαζομένου = '" + jTextField1.getText() + "', " +
            "Μηνιαίος_μισθός = '" + jTextField2.getText() + "', " +
            "Ωριαίος_μισθός = '" + jTextField3.getText() + "' " +
...
try {
    ...
    if (resultSet.next()) {
        ...
        String deleteQuery = "DELETE FROM μισθοι_εργαζομενων WHERE Κωδικός_εργαζομένου = " + Κωδικός_εργαζομένου;
